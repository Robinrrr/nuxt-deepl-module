...
export function useLogger() {
  ...
  return {
    log: (message: string) => consola.log(`${prefix} ${message}`),
    info: (message: string) => consola.info(`${prefix} ${message}`),
    error: (message: string) => consola.error(`${prefix} ${message}`),
    warn: (message: string) => consola.warn(`${prefix} ${message}`),
  }
}
